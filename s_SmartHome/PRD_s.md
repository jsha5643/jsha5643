...
>
> - `준석` → 본인 이름 또는 프로젝트명 (예: "김민준 스마트홈")
> - `ESP_Js` → ESP32 블루투스 기기 이름 (예: `ESP_student01`)
> - `img/4.pbm` → OLED에 출력할 이미지 파일명 (예: `pikachu.pbm`)
>
...
| 항목                     | 내용                                         |
| :----------------------- | :------------------------------------------- |
| **프로젝트명**     | `준석`의 스마트홈 대시보드             |
| **제작자**         | `준석`                                   |
| **BLE 기기명**     | `ESP_Js` (예: `ESP_student01`)            |
| **OLED 이미지**    | `img/4.pbm` (예: `img/pikachu.pbm`) |
| **메인 컬러 테마** | 파란색계열                                   |
...
- [ ] **프로젝트명** 변경: `준석`을 본인 이름으로 수정
- [ ] **BLE 기기명** 변경: `ESP_Js`을 본인 기기명으로 수정 (예: `ESP_minsu`)
